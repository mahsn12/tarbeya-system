import * as AriaUtils from 'ag-grid-community/dist/lib/utils/aria';
export declare const _: {
    ...
    sortRowNodesByOrder(rowNodes: import("ag-grid-community/dist/lib/main").RowNode<any>[], rowNodeOrder: {
        [id: string]: number;
    }): boolean;
    traverseNodesWithKey(nodes: import("ag-grid-community/dist/lib/main").RowNode<any>[] | null, callback: (node: import("ag-grid-community/dist/lib/main").RowNode<any>, key: string) => void): void;
    ...
    isUserSuppressingKeyboardEvent(gridOptionsService: import("ag-grid-community/dist/lib/gridOptionsService").GridOptionsService, keyboardEvent: KeyboardEvent, rowNode: import("ag-grid-community/dist/lib/main").IRowNode<any>, column: import("ag-grid-community/dist/lib/main").Column, editing: boolean): boolean;
    isUserSuppressingHeaderKeyboardEvent(gridOptionsService: import("ag-grid-community/dist/lib/gridOptionsService").GridOptionsService, keyboardEvent: KeyboardEvent, headerRowIndex: number, column: import("ag-grid-community/dist/lib/main").Column | import("ag-grid-community/dist/lib/main").ColumnGroup): boolean;
    ...
    createIcon(iconName: string, gridOptionsService: import("ag-grid-community/dist/lib/gridOptionsService").GridOptionsService, column: import("ag-grid-community/dist/lib/main").Column | null): Element;
    createIconNoSpan(iconName: string, gridOptionsService: import("ag-grid-community/dist/lib/gridOptionsService").GridOptionsService, column?: import("ag-grid-community/dist/lib/main").Column | null | undefined, forceCreate?: boolean | undefined): Element | undefined;
    iconNameClassMap: {
        [key: string]: string;
    };
    ...
    getCtrlForEventTarget<T_17>(gridOptionsService: import("ag-grid-community/dist/lib/gridOptionsService").GridOptionsService, eventTarget: EventTarget | null, type: string): T_17 | null;
    ...
    addSafePassiveEventListener(frameworkOverrides: import("ag-grid-community/dist/lib/main").IFrameworkOverrides, eElement: HTMLElement, event: string, listener: (event?: any) => void): void;
    ...
    addStylesToElement(eElement: any, styles: import("ag-grid-community/dist/lib/main").RowStyle | import("ag-grid-community/dist/lib/main").CellStyle | null | undefined): void;

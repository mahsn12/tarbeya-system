import { ISimpleFilterModel, SimpleFilterModelFormatter, Tuple } from 'ag-grid-community/dist/lib/filter/provided/simpleFilter';
import { ScalarFilter, Comparator, IScalarFilterParams } from 'ag-grid-community/dist/lib/filter/provided/scalarFilter';
import { AgInputTextField } from 'ag-grid-community/dist/lib/widgets/agInputTextField';
import { IFilterOptionDef, IFilterParams } from 'ag-grid-community/dist/lib/interfaces/iFilter';
import { AgInputNumberField } from 'ag-grid-community/dist/lib/widgets/agInputNumberField';
...
export declare class NumberFilter extends ScalarFilter<NumberFilterModel, number> {
    static DEFAULT_FILTER_OPTIONS: import("ag-grid-community/dist/lib/filter/provided/simpleFilter").ISimpleFilterModelType[];

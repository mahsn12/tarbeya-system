import { ColDef, KeyCreatorParams, ValueFormatterParams } from 'ag-grid-community/dist/lib/entities/colDef';
import { IProvidedFilter, IProvidedFilterParams } from 'ag-grid-community/dist/lib/filter/provided/providedFilter';
...
import { IFilterParams, ProvidedFilterModel } from 'ag-grid-community/dist/lib/interfaces/iFilter';
import { AgPromise } from 'ag-grid-community/dist/lib/utils/promise';
